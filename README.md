...
FichierDescriptionmain.py / password.py💠 Version n°1 : style 1, logique classiquemain1.py / mots_de_passe.py💠 Version n°2 : même programme mais écrit différemment
Les deux :
